      ...
      <ScrollArea className="h-[calc(100vh-150px)]">
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                ...
                <li><strong className="text-foreground"><Apple className="inline h-5 w-5 mr-1 text-red-500" />Food:</strong> Crucial for feeding your population. Produced by Farms. Each citizen consumes 1 food per turn.</li>
                ...
                <li><strong className="text-foreground"><Users className="inline h-5 w-5 mr-1 text-blue-500" />Population:</strong> Represents your citizens. More population allows for more workers but also increases food consumption. Population is increased by building housing (like <Home className="inline h-4 w-4" /> Huts) and can decrease due to starvation or events. If your population reaches zero, it&apos;s Game Over!</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                ...
                <li>Buildings <strong className="text-foreground">produce</strong> resources or provide other benefits (e.g., housing, passive bonuses like the <Library className="inline h-4 w-4" /> Library).</li>
                <li>You can <strong className="text-foreground">demolish</strong> existing buildings by clicking the <Trash2 className="inline h-4 w-4 text-destructive" /> icon next to them in the &quot;Realm Status&quot; card. You&apos;ll recover a portion of their construction cost.</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg border-destructive">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>Your realm will fall if your <strong className="text-destructive">population drops to zero</strong>. This can happen due to starvation, events, or demolishing essential housing.</p>
